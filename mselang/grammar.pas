...
const
 ...
 tk_shr = $1CBE839C;
 tk_not = $397D0738;
 tk_inherited = $72FA0E70;

 tokens: array[0..83] of string = ('',
  ...
  'class','private','protected','public','published','or','xor','and','shl',
  'shr','not','inherited');

 tokenids: array[0..83] of identty = (
