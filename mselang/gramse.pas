...
var
 ...
 rttidirectiveco: contextty = (branch: nil; 
               handleentry: nil; handleexit: nil; 
               continue: false; restoresource: false; cutafter: false; 
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'rttidirective');
 rttidirective1co: contextty = (branch: nil; 
               handleentry: nil; handleexit: nil; 
               continue: false; restoresource: false; cutafter: false; 
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'rttidirective1');
 ...
 linecomment1_mseco: contextty = (branch: nil; 
               handleentry: nil; handleexit: nil; 
               continue: true; restoresource: false; cutafter: false; 
               pop: true; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'linecomment1_mse');
 ...
 paramsdef0co: contextty = (branch: nil; 
               ...
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'paramsdef0');
 paramsdef0aco: contextty = (branch: nil; 
               handleentry: nil; handleexit: nil; 
               continue: false; restoresource: false; cutafter: false; 
               pop: true; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'paramsdef0a');
 ...
 virtualco: contextty = (branch: nil; 
               ...
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'virtual');
 abstractco: contextty = (branch: nil; 
               handleentry: nil; handleexit: nil; 
               continue: false; restoresource: false; cutafter: false; 
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'abstract');
 ...
 subheader4co: contextty = (branch: nil; 
               ...
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'subheader4');
 subheaderattachco: contextty = (branch: nil; 
               handleentry: nil; handleexit: nil; 
               continue: false; restoresource: false; cutafter: true; 
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'subheaderattach');
 external0co: contextty = (branch: nil; 
               handleentry: nil; handleexit: nil; 
               continue: false; restoresource: false; cutafter: false; 
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'external0');
 external1co: contextty = (branch: nil; 
               handleentry: nil; handleexit: nil; 
               continue: false; restoresource: false; cutafter: false; 
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'external1');
 external2co: contextty = (branch: nil; 
               handleentry: nil; handleexit: nil; 
               continue: false; restoresource: false; cutafter: false; 
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'external2');
 ...
 except1co: contextty = (branch: nil; 
               ...
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'except1');
 except2co: contextty = (branch: nil; 
               handleentry: nil; handleexit: nil; 
               continue: false; restoresource: false; cutafter: true; 
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'except2');
 except3co: contextty = (branch: nil; 
               handleentry: nil; handleexit: nil; 
               continue: false; restoresource: false; cutafter: false; 
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'except3');
 ...
 labeldef1co: contextty = (branch: nil; 
               ...
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'labeldef1');
 resourcestringco: contextty = (branch: nil; 
               handleentry: nil; handleexit: nil; 
               continue: false; restoresource: false; cutafter: false; 
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
 ...
 var3co: contextty = (branch: nil; 
               ...
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'var3');
 extvar0co: contextty = (branch: nil; 
               handleentry: nil; handleexit: nil; 
               continue: false; restoresource: false; cutafter: false; 
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'extvar0');
 extvar0aco: contextty = (branch: nil; 
               handleentry: nil; handleexit: nil; 
               continue: false; restoresource: false; cutafter: false; 
               pop: true; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'extvar0a');
 extvar1co: contextty = (branch: nil; 
               handleentry: nil; handleexit: nil; 
               continue: false; restoresource: false; cutafter: false; 
               pop: true; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'extvar1');
 extvar2co: contextty = (branch: nil; 
               handleentry: nil; handleexit: nil; 
               continue: false; restoresource: false; cutafter: false; 
               pop: true; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'extvar2');
 ...
 insimpexp1co: contextty = (branch: nil; 
               ...
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'insimpexp1');
 issimpexpco: contextty = (branch: nil; 
               handleentry: nil; handleexit: nil; 
               continue: false; restoresource: false; cutafter: false; 
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'issimpexp');
 issimpexp1co: contextty = (branch: nil; 
               handleentry: nil; handleexit: nil; 
               continue: false; restoresource: false; cutafter: false; 
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'issimpexp1');
 ...
 listfactco: contextty = (branch: nil; 
               ...
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'listfact');
 listfact1aco: contextty = (branch: nil; 
               handleentry: nil; handleexit: nil; 
               continue: false; restoresource: false; cutafter: false; 
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'listfact1a');
 ...
 checkvalueparams0co: contextty = (branch: nil; 
               handleentry: nil; handleexit: nil; 
               continue: false; restoresource: false; cutafter: false; 
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
               caption: 'checkvalueparams0');
 checkvalueparams1co: contextty = (branch: nil; 
               handleentry: nil; handleexit: nil; 
               continue: false; restoresource: false; cutafter: false; 
               pop: false; popexe: false; cutbefore: false; nexteat: false; next: nil;
...
const
 bstart: array[0..7] of branchty = (
   (flags: [bf_nt,bf_keyword,bf_eat];
     ...
     keyword: $0000025B{'unit'}),
   (flags: [bf_nt,bf_keyword,bf_eat];
     dest: (context: @program0co); stack: nil; 
     keyword: $0000025C{'program'}),
 ...
 bunit3: array[0..7] of branchty = (
   (flags: [bf_nt,bf_keyword,bf_eat];
     ...
     keyword: $0000025D{'interface'}),
   (flags: [bf_nt,bf_keyword,bf_eat];
     dest: (context: @implementationco); stack: nil; 
     keyword: $0000025E{'implementation'}),
   (flags: [bf_nt,bf_eat,bf_push,bf_setparentbeforepush];
     dest: (context: @directiveco); stack: nil; keys: (
    (kind: bkk_charcontinued; chars: ['{']),
    (kind: bkk_char; chars: ['$']),
 ...
 buses0: array[0..15] of branchty = (
   (flags: [bf_nt,bf_keyword];
     dest: (context: @usesokco); stack: nil; 
     keyword: $0000025E{'implementation'}),
   (flags: [bf_nt,bf_keyword];
     dest: (context: @usesokco); stack: nil; 
     keyword: $00000260{'type'}),
   (flags: [bf_nt,bf_keyword];
     dest: (context: @usesokco); stack: nil; 
     keyword: $00000261{'const'}),
   (flags: [bf_nt,bf_keyword];
     dest: (context: @usesokco); stack: nil; 
     keyword: $00000262{'var'}),
   (flags: [bf_nt,bf_keyword];
     dest: (context: @usesokco); stack: nil; 
     keyword: $00000263{'threadvar'}),
   (flags: [bf_nt,bf_keyword];
     dest: (context: @usesokco); stack: nil; 
     keyword: $00000264{'resourcestring'}),
   (flags: [bf_nt,bf_keyword];
     dest: (context: @usesokco); stack: nil; 
     keyword: $00000265{'procedure'}),
   (flags: [bf_nt,bf_keyword];
     dest: (context: @usesokco); stack: nil; 
     keyword: $00000266{'method'}),
   (flags: [bf_nt,bf_keyword];
     dest: (context: @usesokco); stack: nil; 
     keyword: $00000265{'procedure'}),
   (flags: [bf_nt,bf_eat,bf_push,bf_setparentbeforepush];
 ...
 bstart2: array[0..16] of branchty = (
   (flags: [bf_nt,bf_keyword,bf_eat];
     dest: (context: @implementationco); stack: nil; 
     keyword: $0000025E{'implementation'}),
   (flags: [bf_nt,bf_keyword,bf_eat,bf_push];
   ...
   (flags: [bf_nt,bf_keyword,bf_eat,bf_push];
     ...
     keyword: $00000263{'threadvar'}),
   (flags: [bf_nt,bf_keyword,bf_eat,bf_push];
     dest: (context: @resourcestringco); stack: nil; 
     keyword: $00000264{'resourcestring'}),
   (flags: [bf_nt,bf_keyword,bf_eat,bf_push];
     dest: (context: @labeldefco); stack: nil; 
     keyword: $00000267{'label'}),
   (flags: [bf_nt,bf_keyword,bf_eat];
     dest: (context: @start2classco); stack: nil; 
     keyword: $00000268{'class'}),
 ...
 bstart2class: array[0..7] of branchty = (
 ...
 bmain1class: array[0..7] of branchty = (
 ...
 bdirective: array[0..22] of branchty = (
   ...
   (flags: [bf_nt,bf_keyword,bf_push];
     dest: (context: @ignoreddirectiveco); stack: nil; 
     keyword: $0000027F{'inline'}),
   (flags: [bf_nt,bf_keyword,bf_push];
     dest: (context: @rttidirectiveco); stack: nil; 
     keyword: $00000230{ 'rtti'}),
   (flags: [bf_nt,bf_eat,bf_push];
     dest: (context: nil); stack: nil; keys: (
    (kind: bkk_char; chars: ['}']),
    (kind: bkk_none; chars: []),
 ...
 brttidirective: array[0..1] of branchty = (
   (flags: [bf_nt,bf_emptytoken,bf_push,bf_setparentbeforepush];
     dest: (context: @getidentco); stack: nil; keys: (
    (kind: bkk_char; chars: [#0..#255]),
    (kind: bkk_none; chars: []),
 ...
 brttidirective1: array[0..2] of branchty = (
   (flags: [bf_nt,bf_eat];
     dest: (context: nil); stack: nil; keys: (
    (kind: bkk_char; chars: [#10,#13,' ']),
    (kind: bkk_none; chars: []),
 ...
 blinecomment0: array[0..2] of branchty = (
   (flags: [bf_nt,bf_eat];
     dest: (context: @linecomment1_mseco); stack: nil; keys: (
 ...
 bparamsdef1: array[0..7] of branchty = (
   (flags: [bf_nt,bf_eat,bf_push,bf_setparentbeforepush];
     dest: (context: @directiveco); stack: nil; keys: (
    (kind: bkk_charcontinued; chars: ['{']),
    (kind: bkk_char; chars: ['$']),
 ...
 bclasubheader3: array[0..8] of branchty = (
   (flags: [bf_nt,bf_eat,bf_push,bf_setparentbeforepush];
     dest: (context: @directiveco); stack: nil; keys: (
    (kind: bkk_charcontinued; chars: ['{']),
    (kind: bkk_char; chars: ['$']),
 ...
 bsubheader3: array[0..7] of branchty = (
   (flags: [bf_nt,bf_eat,bf_push,bf_setparentbeforepush];
     dest: (context: @directiveco); stack: nil; keys: (
    (kind: bkk_charcontinued; chars: ['{']),
    (kind: bkk_char; chars: ['$']),
   ...
   (flags: [bf_nt,bf_eat,bf_push,bf_continue,bf_setparentbeforepush];
     dest: (context: @subheaderattachco); stack: nil; keys: (
    (kind: bkk_char; chars: ['[']),
    (kind: bkk_none; chars: []),
    (kind: bkk_none; chars: []),
    (kind: bkk_none; chars: [])
 ...
 bsubheaderattach: array[0..1] of branchty = (
   (flags: [bf_nt,bf_emptytoken,bf_push,bf_setparentbeforepush];
     dest: (context: @attachco); stack: nil; keys: (
    (kind: bkk_char; chars: [#0..#255]),
    (kind: bkk_none; chars: []),
 ...
 bexternal0: array[0..8] of branchty = (
   (flags: [bf_nt,bf_keyword,bf_eat];
     dest: (context: @external2co); stack: nil; 
     keyword: $00000284{'name'}),
   (flags: [bf_nt,bf_eat,bf_push,bf_setparentbeforepush];
     dest: (context: @directiveco); stack: nil; keys: (
    (kind: bkk_charcontinued; chars: ['{']),
    (kind: bkk_char; chars: ['$']),
   ...
   (flags: [bf_nt];
     dest: (context: @subheader3co); stack: nil; keys: (
    (kind: bkk_char; chars: [';']),
    (kind: bkk_none; chars: []),
    (kind: bkk_none; chars: []),
    (kind: bkk_none; chars: [])
 ...
 bexternal1: array[0..6] of branchty = (
   (flags: [bf_nt,bf_keyword,bf_eat];
     dest: (context: @external2co); stack: nil; 
     keyword: $00000284{'name'}),
   (flags: [bf_nt,bf_eat,bf_push,bf_setparentbeforepush];
 ...
 bexternal2: array[0..1] of branchty = (
   (flags: [bf_nt,bf_emptytoken,bf_push,bf_setparentbeforepush];
     dest: (context: @expco); stack: nil; keys: (
    (kind: bkk_char; chars: [#0..#255]),
    (kind: bkk_none; chars: []),
 ...
 btry1: array[0..2] of branchty = (
   (flags: [bf_nt,bf_keyword,bf_eat];
     ...
     keyword: $00000285{'finally'}),
   (flags: [bf_nt,bf_keyword,bf_eat];
     dest: (context: @exceptco); stack: nil; 
     keyword: $00000234{'except'}),
   (flags: []; dest: (context: nil); stack: nil; keyword: 0)
   );
 ...
 bexcept1: array[0..6] of branchty = (
   (flags: [bf_nt,bf_keyword,bf_eat];
     dest: (context: @except3co); stack: nil; 
     keyword: $0000027B{'else'}),
   (flags: [bf_nt,bf_eat,bf_push,bf_setparentbeforepush];
     dest: (context: @directiveco); stack: nil; keys: (
    (kind: bkk_charcontinued; chars: ['{']),
 ...
 bexcept2: array[0..1] of branchty = (
   (flags: [bf_nt,bf_emptytoken,bf_push];
     dest: (context: @checkendco); stack: nil; keys: (
    (kind: bkk_char; chars: [#0..#255]),
    (kind: bkk_none; chars: []),
 ...
 bexcept3: array[0..1] of branchty = (
   (flags: [bf_nt,bf_emptytoken,bf_push,bf_setparentbeforepush];
     dest: (context: @statementgroupco); stack: nil; keys: (
    (kind: bkk_char; chars: [#0..#255]),
    (kind: bkk_none; chars: []),
 ...
 braise: array[0..7] of branchty = (
   ...
   (flags: [bf_nt];
     dest: (context: @raise1co); stack: nil; keys: (
    (kind: bkk_char; chars: [';']),
    (kind: bkk_none; chars: []),
    (kind: bkk_none; chars: []),
    (kind: bkk_none; chars: [])
 ...
 bexceptlabel: array[0..6] of branchty = (
   (flags: [bf_nt,bf_eat,bf_push,bf_setparentbeforepush];
     dest: (context: @directiveco); stack: nil; keys: (
    (kind: bkk_charcontinued; chars: ['{']),
    (kind: bkk_char; chars: ['$']),
 ...
 bgettype: array[0..18] of branchty = (
   (flags: [bf_nt,bf_keyword,bf_eat,bf_push,bf_setparentbeforepush];
     ...
     keyword: $00000294{'set'}),
   (flags: [bf_nt,bf_keyword,bf_eat];
     dest: (context: nil); stack: nil; 
     keyword: $00000295{'packed'}),
   (flags: [bf_nt,bf_keyword,bf_eat,bf_push,bf_setparentbeforepush];
     dest: (context: @recorddefco); stack: nil; 
     keyword: $00000296{'record'}),
   (flags: [bf_nt,bf_keyword,bf_eat,bf_push,bf_setparentbeforepush];
     dest: (context: @arraydefco); stack: nil; 
     keyword: $00000297{'array'}),
   (flags: [bf_nt,bf_keyword,bf_eat,bf_push,bf_setparentbeforepush];
     dest: (context: @objectdefco); stack: nil; 
     keyword: $00000298{'object'}),
   (flags: [bf_nt,bf_keyword,bf_eat,bf_push,bf_setparentbeforepush];
 ...
 blabeldef: array[0..23] of branchty = (
   (flags: [bf_nt,bf_keyword,bf_push];
     dest: (context: nil); stack: nil; 
     keyword: $0000025E{ 'implementation'}),
   (flags: [bf_nt,bf_keyword,bf_push];
 ...
 bresourcestring: array[0..1] of branchty = (
   (flags: [bf_nt,bf_emptytoken];
     dest: (context: @constaco); stack: nil; keys: (
    (kind: bkk_char; chars: [#0..#255]),
    (kind: bkk_none; chars: []),
    (kind: bkk_none; chars: []),
    (kind: bkk_none; chars: [])
 ...
 bconsta: array[0..23] of branchty = (
   (flags: [bf_nt,bf_keyword,bf_push];
     dest: (context: nil); stack: nil; 
     keyword: $0000025E{ 'implementation'}),
   (flags: [bf_nt,bf_keyword,bf_push];
 ...
 bvar3: array[0..6] of branchty = (
   (flags: [bf_nt,bf_keyword,bf_eat,bf_push,bf_setparentbeforepush];
     dest: (context: @extvar0co); stack: nil; 
     keyword: $00000299{'external'}),
   (flags: [bf_nt,bf_eat,bf_push,bf_setparentbeforepush];
     dest: (context: @directiveco); stack: nil; keys: (
    (kind: bkk_charcontinued; chars: ['{']),
    (kind: bkk_char; chars: ['$']),
 ...
 bextvar0: array[0..8] of branchty = (
   (flags: [bf_nt,bf_keyword,bf_eat];
     dest: (context: @extvar2co); stack: nil; 
     keyword: $00000284{'name'}),
   (flags: [bf_nt,bf_eat,bf_push,bf_setparentbeforepush];
     dest: (context: @directiveco); stack: nil; keys: (
    (kind: bkk_charcontinued; chars: ['{']),
   ...
   (flags: [bf_nt];
     dest: (context: @extvar0aco); stack: nil; keys: (
    (kind: bkk_char; chars: [';']),
    (kind: bkk_none; chars: []),
    (kind: bkk_none; chars: []),
    (kind: bkk_none; chars: [])
 ...
 bextvar1: array[0..6] of branchty = (
   (flags: [bf_nt,bf_keyword,bf_eat];
     dest: (context: @extvar2co); stack: nil; 
     keyword: $00000284{'name'}),
   (flags: [bf_nt,bf_eat,bf_push,bf_setparentbeforepush];
 ...
 bextvar2: array[0..1] of branchty = (
   (flags: [bf_nt,bf_emptytoken,bf_push,bf_setparentbeforepush];
     dest: (context: @expco); stack: nil; keys: (
    (kind: bkk_char; chars: [#0..#255]),
    (kind: bkk_none; chars: []),
 ...
 battachident: array[0..1] of branchty = (
   (flags: [bf_nt,bf_emptytoken,bf_push,bf_setparentbeforepush];
     dest: (context: @ident0co); stack: nil; keys: (
    (kind: bkk_char; chars: [#0..#255]),
    (kind: bkk_none; chars: []),
    (kind: bkk_none; chars: []),
    (kind: bkk_none; chars: [])
 ...
 bclassproperty3: array[0..8] of branchty = (
   (flags: [bf_nt,bf_keyword,bf_eat];
     ...
     keyword: $0000029F{'read'}),
   (flags: [bf_nt,bf_keyword,bf_eat];
     dest: (context: @writepropco); stack: nil; 
     keyword: $000002A0{'write'}),
   (flags: [bf_nt,bf_eat,bf_push,bf_setparentbeforepush];
     dest: (context: @directiveco); stack: nil; keys: (
    (kind: bkk_charcontinued; chars: ['{']),
    (kind: bkk_char; chars: ['$']),
 ...
 bexp1pop: array[0..25] of branchty = (
   (flags: [bf_nt,bf_keyword,bf_eat,bf_push,bf_continue];
     dest: (context: @divfactco); stack: nil; 
     keyword: $000002A1{'div'}),
   (flags: [bf_nt,bf_keyword,bf_eat,bf_push,bf_continue];
 ...
 bissimpexp: array[0..1] of branchty = (
   (flags: [bf_nt,bf_emptytoken,bf_push];
     dest: (context: @factco); stack: nil; keys: (
    (kind: bkk_char; chars: [#0..#255]),
    (kind: bkk_none; chars: []),
 ...
 bissimpexp1: array[0..17] of branchty = (
   (flags: [bf_nt,bf_keyword,bf_eat,bf_push,bf_continue];
     dest: (context: @divfactco); stack: nil; 
     keyword: $000002A1{'div'}),
   (flags: [bf_nt,bf_keyword,bf_eat,bf_push,bf_continue];
 ...
 blistfact2: array[0..8] of branchty = (
   (flags: [bf_nt,bf_eat,bf_push,bf_setparentbeforepush];
     dest: (context: @directiveco); stack: nil; keys: (
    (kind: bkk_charcontinued; chars: ['{']),
    (kind: bkk_char; chars: ['$']),
   ...
   (flags: [bf_nt,bf_eat];
     dest: (context: @listfact1aco); stack: nil; keys: (
    (kind: bkk_charcontinued; chars: ['.']),
    (kind: bkk_char; chars: ['.']),
    (kind: bkk_none; chars: []),
    (kind: bkk_none; chars: [])
 ...
 bcheckvalueparams: array[0..6] of branchty = (
   ...
   (flags: [bf_nt,bf_eat];
     dest: (context: @checkvalueparams0co); stack: nil; keys: (
    (kind: bkk_char; chars: ['(']),
    (kind: bkk_none; chars: []),
    (kind: bkk_none; chars: []),
    (kind: bkk_none; chars: [])
 ...
 bcheckvalueparams0: array[0..1] of branchty = (
   (flags: [bf_nt,bf_emptytoken,bf_eat,bf_push,bf_setparentbeforepush];
 ...
 bvaluepath1: array[0..7] of branchty = (
   (flags: [bf_nt,bf_eat,bf_push,bf_setparentbeforepush];
     dest: (context: @directiveco); stack: nil; keys: (
    (kind: bkk_charcontinued; chars: ['{']),
    (kind: bkk_char; chars: ['$']),
   ...
   (flags: [bf_nt,bf_handler,bf_push];
     dest: (handler: nil); stack: nil; keys: (
    (kind: bkk_charcontinued; chars: ['.']),
    (kind: bkk_char; chars: ['.']),
    (kind: bkk_none; chars: []),
    (kind: bkk_none; chars: [])
...
begin
 ...
 rttidirectiveco.branch:= @brttidirective;
 rttidirectiveco.next:= @rttidirective1co;
 rttidirective1co.branch:= @brttidirective1;
 rttidirective1co.next:= @directiveendco;
 rttidirective1co.handleexit:= @handlerttidirective;
 ...
 linecomment1_mseco.branch:= nil;
 linecomment1_mseco.handleexit:= @handlecommentend;
 ...
 paramsdef0co.next:= @paramsdef0aco;
 paramsdef0co.handleentry:= @handleparamsdefentry;
 paramsdef0aco.branch:= nil;
 paramsdef0aco.handleexit:= @handleparamsdef;
 ...
 abstractco.branch:= nil;
 abstractco.next:= @clasubheader3co;
 abstractco.handleentry:= @handleabstract;
 ...
 subheader4co.branch:= nil;
 subheader4co.handleexit:= @handlesubheader;
 subheaderattachco.branch:= @bsubheaderattach;
 subheaderattachco.handleexit:= @handlesubheaderattach;
 external0co.branch:= @bexternal0;
 external0co.next:= @external1co;
 external0co.handleentry:= @handleexternal0entry;
 external0co.handleexit:= @handleexternal0;
 external1co.branch:= @bexternal1;
 external1co.next:= @subheader3co;
 external2co.branch:= @bexternal2;
 external2co.next:= @subheader3co;
 external2co.handleexit:= @handleexternal2;
 ...
 except1co.next:= @except2co;
 except2co.branch:= @bexcept2;
 except2co.handleentry:= @handleexcept;
 except3co.branch:= @bexcept3;
 except3co.next:= @except2co;
 except3co.handleentry:= @handleexceptelse;
 raiseco.branch:= @braise;
 raiseco.handleexit:= @handleraise;
 raise1co.branch:= nil;
 raise1co.handleexit:= @handleraise1;
 gotoco.branch:= @bgoto;
 ...
 typeco.branch:= @btype;
 typeco.handleentry:= @handletypedefentry;
 ...
 resourcestringco.branch:= @bresourcestring;
 resourcestringco.handleentry:= @handleresourcestringentry;
 constco.branch:= @bconst;
 constco.handleentry:= @handleconstentry;
 constaco.branch:= @bconsta;
 ...
 extvar0co.branch:= @bextvar0;
 extvar0co.next:= @extvar1co;
 ...
 issimpexpco.branch:= @bissimpexp;
 issimpexpco.next:= @issimpexp1co;
 issimpexp1co.branch:= @bissimpexp1;
 issimpexp1co.handleexit:= @handleissimpexp;
 ...
 listfact1aco.branch:= nil;
 listfact1aco.next:= @listfact1co;
 listfact1aco.handleentry:= @listfact1aentry;
 ...
 checkvalueparams0co.branch:= @bcheckvalueparams0;
