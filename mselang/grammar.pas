...
const
 ...
 tk_is = $FA0E707A;
 tk_as = $F41CE0F5;
 tk_inherited = $E839C1EA;

 tokens: array[0..93] of string = ('',
  ...
  'class','private','protected','public','published','and','shl','shr','or',
  'xor','in','not','is','as','inherited');

 tokenids: array[0..93] of identty = (
