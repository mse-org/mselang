...
const
 ...
 tk_new = $0000022F;
 tk_dispose = $00000230;
 tk_afterconstruct = $00000231;
 tk_beforedestruct = $00000232;
 tk_ini = $00000233;
 tk_fini = $00000234;
 tk_incref = $00000235;
 tk_decref = $00000236;
 tk_operator = $00000237;
 tk_operatorright = $00000238;
 tk_default = $00000239;
 tk_unit = $0000023A;
 tk_program = $0000023B;
 tk_interface = $0000023C;
 tk_implementation = $0000023D;
 tk_uses = $0000023E;
 tk_type = $0000023F;
 tk_const = $00000240;
 tk_var = $00000241;
 tk_label = $00000242;
 tk_class = $00000243;
 tk_procedure = $00000244;
 tk_function = $00000245;
 tk_method = $00000246;
 tk_initialization = $00000247;
 tk_finalization = $00000248;
 tk_constructor = $00000249;
 tk_destructor = $0000024A;
 tk_begin = $0000024B;
 tk_mode = $0000024C;
 tk_dumpelements = $0000024D;
 tk_dumpopcode = $0000024E;
 tk_abort = $0000024F;
 tk_stoponerror = $00000250;
 tk_nop = $00000251;
 tk_include = $00000252;
 tk_define = $00000253;
 tk_undef = $00000254;
 ...
 tk_on = $0000025D;
 tk_off = $0000025E;
 tk_constref = $0000025F;
 tk_out = $00000260;
 tk_override = $00000261;
 tk_overload = $00000262;
 tk_of = $00000263;
 tk_object = $00000264;
 tk_external = $00000265;
 tk_forward = $00000266;
 tk_name = $00000267;
 tk_sub = $00000268;
 tk_finally = $00000269;
 ...
 tk_array = $0000027A;
 tk_private = $0000027B;
 tk_protected = $0000027C;
 tk_public = $0000027D;
 tk_published = $0000027E;
 tk_property = $0000027F;
 tk_read = $00000280;
 tk_write = $00000281;
 tk_div = $00000282;
 tk_mod = $00000283;
 ...
 tk_not = $0000028B;
 tk_as = $0000028C;
 tk_inherited = $0000028D;

 tokens: array[0..141] of string = ('',
 ...
 tokenids: array[0..141] of identty = (
