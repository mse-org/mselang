...
const
 ...
 tk_shr = $111CBE83;
 tk_not = $22397D07;
 tk_inherited = $4472FA0E;

 tokens: array[0..75] of string = ('',
  ...
  'and','shl','shr','not','inherited');

 tokenids: array[0..75] of identty = (
  ...
  $622397D0,$C4472FA0,$888E5F41,$111CBE83,$22397D07,$4472FA0E);
